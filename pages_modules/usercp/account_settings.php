...
;
			...
			<tr>
			<td align="right"><input type="submit" class="btn btn-success" value="Aceptar" onclick="return prse_inputs()"></td>
...
;
	...
	echo '
			...
			<tr>
			<td align="right"><input type="submit" class="btn btn-success" value="Aceptar" onclick="return prse_inputs()"></td>
			<td align="left"><input type="button" class="btn btn-success" value="Cancelar" onclick="location.href=\''.$core['config']['website_url'].'\'"></td>
			</table>
			</form>';
	}
