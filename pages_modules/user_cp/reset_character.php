					...
					switch ($reset_stats){
						case '1': 
							if($reset_clear_inv == '1' and $reset_clear_skills == '1'){
								$reset_formula = "Update character set [".AOH_Resets_column."]=(".AOH_Resets_column."+1),[clevel]='1',[experience]='0',[leveluppoint]=?,[money]=?,[strength]='25',[dexterity]='25',[vitality]='25',[energy]='25',[inventory]=CONVERT(varbinary(1080), null),[magiclist]=CONVERT(varbinary(180), null) where mu_id=?";
							}elseif ($reset_clear_inv == '1'){
								$reset_formula = "Update character set [".AOH_Resets_column."]=(".AOH_Resets_column."+1),[clevel]='1',[experience]='0',[leveluppoint]=?,[money]=?,[strength]='25',[dexterity]='25',[vitality]='25',[energy]='25',[inventory]=CONVERT(varbinary(1080), null) where mu_id=?";
							}elseif ($reset_clear_skills == '1'){
								$reset_formula = "Update character set [".AOH_Resets_column."]=(".AOH_Resets_column."+1),[clevel]='1',[experience]='0',[leveluppoint]=?,[money]=?,[strength]='25',[dexterity]='25',[vitality]='25',[energy]='25',[magiclist]=CONVERT(varbinary(180), null) where mu_id=?";
							}elseif ($reset_clear_inv == '0' and $reset_clear_skills == '0'){
								$reset_formula = "Update character set [".AOH_Resets_column."]=(".AOH_Resets_column."+1),[clevel]='1',[experience]='0',[leveluppoint]=?,[money]=?,[strength]='25',[dexterity]='25',[vitality]='25',[energy]='25' where mu_id=?";
							}
						break;
						case '0':
							if($reset_clear_inv == '1' and $reset_clear_skills == '1'){
								$reset_formula = "Update character set [".AOH_Resets_column."]=(".AOH_Resets_column."+1),[clevel]='1',[experience]='0',[leveluppoint]=?,[money]=?,[inventory]=CONVERT(varbinary(1080), null),[magiclist]=CONVERT(varbinary(180), null) where mu_id=?";
							}elseif ($reset_clear_inv == '1'){
								$reset_formula = "Update character set [".AOH_Resets_column."]=(".AOH_Resets_column."+1),[clevel]='1',[experience]='0',[leveluppoint]=?,[money]=?,[inventory]=CONVERT(varbinary(1080), null) where mu_id=?";
							}elseif ($reset_clear_skills == '1'){
								$reset_formula = "Update character set [".AOH_Resets_column."]=(".AOH_Resets_column."+1),[clevel]='1',[experience]='0',[leveluppoint]=?,[money]=?,[magiclist]=CONVERT(varbinary(180), null) where mu_id=?";
							}elseif ($reset_clear_inv == '0' and $reset_clear_skills == '0'){
								$reset_formula = "Update character set [".AOH_Resets_column."]=(".AOH_Resets_column."+1),[clevel]='1',[experience]='0',[leveluppoint]=?,[money]=? where mu_id=?";
							}
						break;
					}	
