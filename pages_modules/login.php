...
if(!isset($_POST['process_login'])){
  ...
  <tr>
    <td width="140" class="iRg_text" align="left" height="40px">ID Usuario:</td>
    <td colspan="2" class="iRg_text" align="left"><input type="text" name="uss_id" class="form-control" maxlength="10"></td>
  </tr>
  <tr>
    <td class="iRg_text" align="left">Clave:</td>
    <td width="157" align="left"><input type="password" name="uss_password" class="form-control" maxlength="10"></td>
  </tr><tr>
    <td width="203" align="center" colspan="2" height="50px"><button class="btn btn-success" type="submit" name="Submit" value="'.button_log_in.'">'.button_log_in.'</button> <input type="hidden" name="process_login"></td>
  </tr>
  <tr>
    <td align="center" colspan="2" height="40px"><a class="label label-primary" href="'.ROOT_INDEX.'?'.LOAD_GET_PAGE.'='.LOSTPASSWORD_CMS_PAGE.'">RECUPERAR CONTRASE&Ntilde;A</a></td>
  </tr>
  <tr>
    <td align="center" colspan="2" height="40px"><a class="label label-info" href="'.ROOT_INDEX.'?'.LOAD_GET_PAGE.'='.REGISTER_CMS_PAGE.'">'.link_sign_up.'</a></td>
  </tr>
</table>
</div>
</form>
