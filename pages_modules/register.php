...
<td align="left" class="iRg_inf"><input class="iRg_input " type="text" name="userid" id="userid" maxlength="10" onclick="document.getElementById(\'c_uss\').innerHTML=\'4-10 Caracteres\'" value="' . $userid_post . '"></td>
<td align="left" ><span class="iRg_inf"><div id="c_uss">4-10 Caracteres</div></span></td>
</tr>
</tr>
<tr>
<td align="left" class="iRg_text">Clave</td>
<td align="left"><input class="iRg_input" type="password" name="password" id="password" maxlength="10"></td>
<td align="left"><span class="iRg_inf">6-10 Caracteres</span></td>
</tr>
<tr>
<td align="left" class="iRg_text">Re Clave:</td>
<td align="left"><input class="iRg_input" type="password" name="confirm_password" id="confirm_password" maxlength="10"> <span class="iRg_inf"></span></td>
</tr>
</tr>';
        if ($get_config->pers_id_active == '1') {
            echo '<tr>
...
<td align="left" class="iRg_inf"><input class="iRg_input" maxlength="50" type="text" name="email_address" id="email_address" onclick="document.getElementById(\'c_mss\').innerHTML=\'' . text_register_req5 . '\'" value="' . $email_post . '"></td>
</tr>
<tr>
