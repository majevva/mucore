...
<body>
	...
	<div class="maintenance" style="margin-top: 40px;">
	 <div class="maintenance_title" align="left">Install Presente</div>
	 <div class="maintenance_reason" align="left">
	 Por su seguridad, elimine la carpeta <strong>"install"</strong> para poder visualizar la pagina.
	</div>
	<div class="maintenance_author" align="right" style="margin-top: 4px;">Sorry for inconvience,<br><b>MuCore Premium Team</b></div>
	</div>
	</div>
</body>
</html>
