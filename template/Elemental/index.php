...
<div class="nav_logo">
<a class="navbar-brand" href="<? echo $core['config']['website_url'];?>">
<img src="template/<?=$core['config']['template'] ?>/images/logoserver.png">
</a>
</div>
...
<div class="header">
	<div class="divnames">
		<div class="divnserver">
		<h1><?=$config_template->Nombre;?></h1>
		<p><?=$config_template->Slogan;?></p>
		</div>

		<div class="divserverlogo"><img src="template/<?=$core['config']['template'] ?>/images/tpl/00-06.png"></div>
	</div>
</div>
...
<div class="brian_cl">	
  ...
  <tr>
    <td style="height: 25px;" width="130" colspan="2">
    <input type="text"  name="uss_id" maxlength="10" class="login_field" value="USUARIO" OnClick="this.value=\'\'">
    </td>
  </tr>
  <tr>
    <td style="height: 10px;" colspan="2">
    <input type="password"  name="uss_password" class="login_field" value="PASSWORD" maxlength="12" OnClick="this.value=\'\'">
    <input type="hidden" name="process_login">
    </td>
  </tr>
  <tr>
    <td style="width:80px" class="yellow">
    
    <button class="btn btn-success" onclick="uss_login_form.submit();">Entrar</button>
    </td>
    <td style="width:132px" >
    <a  class="btn btn-info" href="index.php?page_id=lost_password">Recuperar Clave</a>
    </td>
  </tr>
</table>
</form>';
...
<ul>
		  ...
		  <div class="brian_cl">
		  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
		  <td><h1 class="entrar" align="center" style="margin-top:2px;">INFORMACION</h1></td>
		  </tr>
		  </table>
			<table style="text-align:left;" cellspacing="0" cellpadding="0">
                                                              <tr>
                                                                <td width="200" style="color:#DDBE49;"><strong>Version:</strong></td>
					                                            <td width="35"><strong><?=$config_template->Version;?></strong></td>
                                                               </tr>
                                                               <tr>
                                                                <td width="200" style="color:#DDBE49;"><strong>Experiencia:</strong></td>
					                                            <td width="35"><strong><?=$config_template->Exp;?></strong></td>
                                                               </tr>
                                                               <tr>
                                                                <td width="200" style="color:#DDBE49;"><strong>Drop:</strong></td>
					                                            <td width="35"><strong><?=$config_template->Drop;?></strong></td>
                                                               </tr>
															   <tr>
					                        					<td width="200" style="color:#DDBE49;"><strong>Cuentas Totales:</strong></td>
																 <td width="35"><strong><?=$cues;?></strong></td>
																</tr>
															<tr>
...
<footer>
		...
		<div class="container">
		<?=$config_template->Nombre;?> - Todos los derechos reservados.<br>
		MuCore Premium <?=crypt_it($engine,'','1');?>
