...
<input type="text" class="form-control" value="'.$get_config->columns.'" name="columns"><br>
</td>
</tr>
<tr>
...
';
	switch ($get_config->display_class){
		case '0': echo '<label><input type="radio" class="minimal" name="display_class" value="1">Yes</label> <label><input type="radio" class="minimal" name="display_class" value="0" checked="checked">No</label>'; break;
		case '1': echo '<label><input type="radio" class="minimal" name="display_class" value="1" checked="checked">Yes</label> <label><input type="radio" class="minimal" name="display_class" value="0">No</label>'; break;
	}
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->limit_level.'" name="limit_level"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->limit_option.'" name="limit_option"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->limit_exc_option.'" name="limit_exc_option"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->credits_level.'" name="credits_level"><br>
</td>
</tr>
<tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->credits_luck.'" name="credits_luck"><br>
</td>
</tr>
<tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->credits_skill.'" name="credits_skill"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->credits_option.'" name="credits_option"><br>
</td>
</tr>
<tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
Ancient I: <input type="text" class="form-control" value="'.$get_config->credits_ancient1.'" name="credits_ancient1" size="3"><br>
Ancient II: <input type="text" class="form-control" value="'.$get_config->credits_ancient2.'" name="credits_ancient2" size="3"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->credits_refined.'" name="credits_refined"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->credits_harmony.'" name="credits_harmony"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
Option 1: <input type="text" class="form-control" value="'.$get_config->credits_weapon1.'" name="credits_weapon1" size="3"><br>
Option 2: <input type="text" class="form-control" value="'.$get_config->credits_weapon2.'" name="credits_weapon2" size="3"><br>
Option 3: <input type="text" class="form-control" value="'.$get_config->credits_weapon3.'" name="credits_weapon3" size="3"><br>
Option 4: <input type="text" class="form-control" value="'.$get_config->credits_weapon4.'" name="credits_weapon4" size="3"><br>
Option 5: <input type="text" class="form-control" value="'.$get_config->credits_weapon5.'" name="credits_weapon5" size="3"><br>
Option 6: <input type="text" class="form-control" value="'.$get_config->credits_weapon6.'" name="credits_weapon6" size="3"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
Option 1: <input type="text" class="form-control" value="'.$get_config->credits_armor1.'" name="credits_armor1" size="3"><br>
Option 2: <input type="text" class="form-control" value="'.$get_config->credits_armor2.'" name="credits_armor2" size="3"><br>
Option 3: <input type="text" class="form-control" value="'.$get_config->credits_armor3.'" name="credits_armor3" size="3"><br>
Option 4: <input type="text" class="form-control" value="'.$get_config->credits_armor4.'" name="credits_armor4" size="3"><br>
Option 5: <input type="text" class="form-control" value="'.$get_config->credits_armor5.'" name="credits_armor5" size="3"><br>
Option 6: <input type="text" class="form-control" value="'.$get_config->credits_armor6.'" name="credits_armor6" size="3"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
Option 1: <input type="text" class="form-control" value="'.$get_config->credits_wing1.'" name="credits_wing1" size="3"><br>
Option 2: <input type="text" class="form-control" value="'.$get_config->credits_wing2.'" name="credits_wing2" size="3"><br>
Option 3: <input type="text" class="form-control" value="'.$get_config->credits_wing3.'" name="credits_wing3" size="3"><br>
Option 4: <input type="text" class="form-control" value="'.$get_config->credits_wing4.'" name="credits_wing4" size="3"><br>
Option 5: <input type="text" class="form-control" value="'.$get_config->credits_wing5.'" name="credits_wing5" size="3"><br>
</td>
</tr>
