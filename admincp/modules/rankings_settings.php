...
<tr>';
		if($get_config->active == '1'){
			echo '<td align="left" class="panel_buttons" style="background: #00a65a; color:#fff;"><b>Rankings are active.</b></td>
<td align="right" class="panel_buttons" style="background: #00a65a; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn Rankings Off" class="btn btn-block btn-danger btn-200"><input type="hidden" name="module_active" value="0">';
		
			
		}elseif ($get_config->active == '0'){
			echo '<td align="left" class="panel_buttons" style="background: #dd4b39; color:#fff;"><b>Rankings are inactive.</b></td>
<td align="right" class="panel_buttons" style="background: #dd4b39; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn Rankings On" class="btn btn-block btn-success btn-200"><input type="hidden" name="module_active" value="1">';
		}
		echo '</td>
</tr>
</table>
...
<input type="text" class="form-control" value="'.$get_config->cron_job_1.'" name="cron_job_1"><br>
<input type="text" class="form-control" value="'.$get_config->cron_job_2.'" name="cron_job_2"><br>
<input type="text" class="form-control" value="'.$get_config->cron_job_3.'" name="cron_job_3"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" value="'.$get_config->char_top.'" name="char_top">
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" value="'.$get_config->char_top.'" name="guild_top">
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">';
	switch ($get_config->gm){
		case '0': echo '<label><input type="radio" class="minimal" name="gm" value="1">Yes</label> <label><input type="radio" class="minimal" name="gm" checked="checked" value="0">No</label>'; break;
		case '1': echo '<label><input type="radio" class="minimal" name="gm" value="1" checked="checked">Yes</label> <label><input type="radio" class="minimal" name="gm" value="0">No</label>'; break;
	}
	echo '
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">';
	switch ($get_config->char_status){
		case '0': echo '<label><input type="radio" class="minimal" name="char_status" value="1">Yes</label> <label><input type="radio" class="minimal" name="char_status" checked="checked" value="0">No</label>'; break;
		case '1': echo '<label><input type="radio" class="minimal" name="char_status" value="1" checked="checked">Yes</label> <label><input type="radio" class="minimal" name="char_status" value="0">No</label>'; break;
	}
	echo '
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">';
	switch ($get_config->location){
		case '0': echo '<label><input type="radio" class="minimal" name="location" value="1">Yes</label> <label><input type="radio" class="minimal" name="location" checked="checked" value="0">No</label>'; break;
		case '1': echo '<label><input type="radio" class="minimal" name="location" value="1" checked="checked">Yes</label> <label><input type="radio" class="minimal" name="location" value="0">No</label>'; break;
	}
	echo '
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">';
	switch ($get_config->hide_stats){
		case '0': echo '<label><input type="radio" class="minimal" name="hide_stats" value="1">Yes</label> <label><input type="radio" class="minimal" name="hide_stats" checked="checked" value="0">No</label>'; break;
		case '1': echo '<label><input type="radio" class="minimal" name="hide_stats" value="1" checked="checked">Yes</label> <label><input type="radio" class="minimal" name="hide_stats" value="0">No</label>'; break;
	}
	echo '
</td>
</tr>
