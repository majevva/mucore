...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" value="'.$title.'" name="p_title"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" value="'.$page_id.'" name="p_id"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" value="'.$order.'" name="p_order"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="meta_keywords" value="'.$page_keywords.'" size="45"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="meta_description" value="'.$page_description.'" size="45"></td>
</tr>
...
switch ($page_active){
	case '0': echo '<label><input type="radio" class="minimal" name="p_active" value="1"> Yes</label> <label><input type="radio" class="minimal" name="p_active" value="0" checked="checked"> No</label>'; break;
	case '1': echo '<label><input type="radio" class="minimal" name="p_active" value="1" checked="checked"> Yes</label> <label><input type="radio" class="minimal" name="p_active" value="0" > No</label>'; break;
}
echo '</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="50%">';
switch ($page_sql){
	case '0': echo '<label><input type="radio" class="minimal" name="p_sql" value="1"> Yes</label> <label><input type="radio" class="minimal" name="p_sql" value="0" checked="checked"> No</label>'; break;
	case '1': echo '<label><input type="radio" class="minimal" name="p_sql" value="1" checked="checked"> Yes</label> <label><input type="radio" class="minimal" name="p_sql" value="0" > No</label>'; break;
}
echo '</td>
</tr>
...
switch ($page_auth){
	case '0': echo '<label><input type="radio" class="minimal" name="p_auth" value="1"> Yes</label> <label><input type="radio" class="minimal" name="p_auth" value="0" checked="checked"> No</label>'; break;
	case '1': echo '<label><input type="radio" class="minimal" name="p_auth" value="1" checked="checked"> Yes</label> <label><input type="radio" class="minimal" name="p_auth" value="0"> No</label>'; break;
}
...
switch ($page_hide){
	case '1': echo '<label><input type="radio" class="minimal" name="p_hide" value="0"> Yes</label> <label><input type="radio" class="minimal" name="p_hide" value="1" checked="checked"> No</label>'; break;
	case '0': echo '<label><input type="radio" class="minimal" name="p_hide" value="0" checked="checked"> Yes</label> <label><input type="radio" class="minimal" name="p_hide" value="1" > No</label>'; break;
}
echo '
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" value="'.$page_url.'" name="p_url"></td>
</tr>
...
<select name="p_target">';
				switch ($page_target){
					case '0': echo '<option value="0" selected="selected">_self</option><option value="1">_blank</option>'; break;
					case '1': echo '<option value="0">_self</option><option value="1" selected="selected">_blank</option>'; break;
				}
				echo '
				</select></td>
</tr>
...
foreach ($get_pages as $page){
	...
	switch ($page[7]){
		case '0': echo $page[3]; break;
		case '1': echo set_limit($page[10],'30','...');
	}
	
	echo '</td>
	<td align="left" class="panel_text_alt_list"><input type="text" class="form-control" name="display_order['.$page[1].']" value="'.$page[0].'" size="3"></td>
	';
	switch ($page[7]){
		case '0': echo '<td align="left" class="panel_text_alt_list">Built-in Page</td>'; $p_type = 'Built-in Page'; $link_edit = 'index.php?get=edit_pages&m=0&edit_page='.$page[1].''; break;
		case '1': echo '<td align="left" class="panel_text_alt_list">Additional URL</td>'; $p_type = 'Additional URL'; $link_edit = 'index.php?get=edit_pages&m=1&edit_page='.$page[1].''; break;
	}
	switch ($page[8]){
	...
	switch ($page[12]){
		case '0': $sql = 'No'; break;
		case '1': $sql = '<b>Yes</b>'; break;
	}
	switch ($page[9]){
		case '0': $auth = 'No'; break;
		case '1': $auth = '<b>Yes</b>'; break;
	}
	switch ($page[6]){
		case '1': $hide = 'No'; break;
		case '0': $hide = '<b>Yes</b>'; break;
	}
...
<input type="submit" class="btn btn-primary btn-200" value="Save Display Order"> <input type="button" class="btn btn-success btn-200" value="Add New Page" onclick="location.href=\'index.php?get=add_page\'"></td>
</tr>
</table>
</form>
';
