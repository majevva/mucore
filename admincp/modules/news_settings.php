...
<td align="left" class="panel_text_alt2" width="45%" valign="top">';
	...
	switch ($get_news_config->news_style){
		case '0': echo '<label><input type="radio" class="minimal" name="style" value="0" checked="checked">Style 1</label><br><label><input type="radio" class="minimal" name="style" value="1">Style 2</label><br><label><input type="radio" class="minimal" name="style" value="2">Style 3</label>'; break;
		case '1': echo '<label><input type="radio" class="minimal" name="style" value="0">Style 1</label><br><label><input type="radio" class="minimal" name="style" value="1" checked="checked">Style 2</label><br><label><input type="radio" class="minimal" name="style" value="2">Style 3</label>'; break;
		case '2': echo '<label><input type="radio" class="minimal" name="style" value="0">Style 1</label><br><label><input type="radio" class="minimal" name="style" value="1">Style 2</label><br><label><input type="radio" class="minimal" name="style" value="2" checked="checked">Style 3</label>'; break;
	}
	echo'
	</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" value="'.$get_news_config->news_short_long.'" name="short">
</td>
</tr>
...
<select name="bookmarking">';
	switch ($get_news_config->news_bookmarking){
		case '0': echo '<option value="1">Enabled</option><option value="0" selected="selected">Disabled</option>'; break;
		case '1': echo '<option value="1" selected="selected">Enabled</option><option value="0">Disabled</option>'; break;
	}
	echo '
