...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" name="p_title"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" name="p_id"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" name="p_order" value="0"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="meta_keywords" value="'.$core['config']['meta_keywords'].'" size="45"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="meta_description" value="'.$core['config']['meta_description'].'" size="45"></td>
</tr>
...
<label><input type="radio" class="minimal" name="p_active" value="1" checked="checked"> Yes</label> <label><input type="radio" class="minimal" name="p_active" value="0"> No</label>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="50%">
<label><input type="radio" class="minimal" name="p_sql" value="1"> Yes</label> <label><input type="radio" class="minimal" name="p_sql" value="0"  checked="checked"> No</label>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="50%">
<label><input type="radio" class="minimal" name="p_auth" value="1"> Yes</label> <label><input type="radio" class="minimal" name="p_auth" value="0" checked="checked"> No</label>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="50%">
<label><input type="radio" class="minimal" name="p_hide" value="0"> Yes</label> <label><input type="radio" class="minimal" name="p_hide" value="1" checked="checked"> No</label>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" name="p_url"></td>
</tr>
...
<tr> 
<td align="left" class="panel_text_alt1" width="50%">This controls the order that the page will be displayed in for the Website Menu and in the Admin Control Panel.</td>
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" value="0" name="p_order"></td>
</tr>
<tr>
<td align="center" class="panel_buttons" colspan="2">
