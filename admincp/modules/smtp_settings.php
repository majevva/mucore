...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="smtp_server" value="'.$get_config->smtp_server.'"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="smtp_username" value="'.$get_config->smtp_username.'"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="smtp_password" value="'.$get_config->smtp_password.'"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="smtp_port" value="'.$get_config->smtp_port.'"></td>
</tr>
