...
if(isset($_GET['mod'])){
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="ann_title"></td>
	</tr>
	...
	<input type="submit" class="btn btn-block btn-success btn-200" value="Post Announcement"></td>
	</tr>
	...
	<tr>
	<td align="left" class="panel_text_alt1" width="50%">Announcement Title that will appear on announcement.</td>
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="ann_title" value="'.$ann_title.'"></td>
	</tr>
	...
	<input type="submit" class="btn btn-block btn-success btn-200" value="Edit Announcement"></td>
	</tr>
...
<input type="button" value="Post New Announcement" class="btn btn-block btn-success btn-200" onclick="location.href=\'index.php?get=announcements_manager&mod=new\'"></td>
</tr></table>';
