...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="ROOT_INDEX" value="'.ROOT_INDEX.'"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="LOAD_GET_PAGE" value="'.LOAD_GET_PAGE.'"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="USER_GET_PAGE" value="'.USER_GET_PAGE.'"></td>
</tr>
<tr>
...
<input type="hidden" name="settings">
<input type="submit" class="btn bg-olive margin" value="Save">&nbsp;<input class="btn bg-maroon margin" type="reset" value="Reset"></td>
</tr>
</table>
