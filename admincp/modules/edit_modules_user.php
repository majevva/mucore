...
if(isset($_POST['save_order'])){
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="m_title" value="'.$m_title.'"></td>
	</tr>
...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" name="m_id" value="'.$m_idd.'"></td>
</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="m_order" value="'.$m_order.'"></td
	</tr>
	...
	';
				switch ($m_active){
					case '0': echo '<label><input type="radio" class="minimal" name="m_active" value="1">Yes</label> <label><input type="radio" class="minimal" name="m_active" checked="checked" value="0">No'; break;
					case '1': echo '<label><input type="radio" class="minimal" name="m_active" checked="checked" value="1">Yes</label> <label><input type="radio" class="minimal" name="m_active" value="0">No</label>'; break;
				}
				echo '</td
	</tr>
...
switch ($m_hide){
	case '1': echo '<label><input type="radio" class="minimal" name="m_hide" value="1" checked="checked"> Yes</label> <label><input type="radio" class="minimal" name="m_hide" value="0"> No</label>'; break;
	case '0': echo '<label><input type="radio" class="minimal" name="m_hide" value="1"> Yes</label> <label><input type="radio" class="minimal" name="m_hide" value="0"  checked="checked"> No</label>'; break;
}
echo '
</td>
</tr>
	...
	'; include('../engine/cms_data/cms_co/'.$m_id.'_cms.cms');echo '</textarea></td>
	</tr>
	...
	<input type="submit" class="btn btn-success btn-200" value="Edit Module"></td>
	</tr>
...
foreach ($get_modules as $module){
	...
	';
	switch ($module[5]){
		case '0': echo '<td align="left" class="panel_text_alt_list">Template Module</td>'; $p_type = 'Template Module'; $link_edit = 'index.php?get=edit_modules_user&m=0&edit_module='.$module[1].''; break;
		case '1': echo '<td align="left" class="panel_text_alt_list">PHP File Module ('.$module[4].')</td>'; $p_type = 'PHP File Module'; $link_edit = 'index.php?get=edit_modules_user&m=1&edit_module='.$module[1].''; break;
	}
	
	echo '
	<td align="left" class="panel_text_alt_list"><input type="text" class="form-control" name="display_order['.$module[1].']" value="'.$module[0].'" size="3"></td>
	<td align="left" class="panel_text_alt_list">';
	switch ($module[6]){
		case '0': echo '<em>Inactive</em>'; break;
		case '1': echo '<b>Active</b>'; break;
	}
	echo '</td>
	<td align="left" class="panel_text_alt_list">';
	switch ($module[7]){
		case '0': echo 'No'; break;
		case '1': echo '<b>Yes</b>'; break;
	}
	echo '</td>
	';
...
<input type="submit" class="btn btn-primary btn-200" value="Save Display Order"> <input type="button" class="btn btn-success btn-200" value="Add New Module" onclick="location.href=\'index.php?get=add_module_user\'"></td>
</tr>
</table>
</form>
';
