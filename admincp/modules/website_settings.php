...
if(isset($_POST['settings'])){
	...
	if(empty($_POST['w_title']) || empty($_POST['w_url']) || empty($_POST['c_key']) || empty($_POST['w_nick']) || empty($_POST['master_mail']) || empty($_POST['template'])){
		...
		if(strlen($_POST['c_key']) != '8'){
			...
			$data .="\$core['config']['versionserver'] = \"".$_POST['versionserver']."\";\r\n"; 
	...
	if(isset($_POST['module_active'])){
		...
		$data .="\$core['config']['versionserver'] = \"".$core['config']['versionserver']."\";\r\n"; 
...
<tr>';
		if($core['config']['on_off'] == '1'){
			echo '<td align="left" class="panel_buttons" style="background: #00a65a; color:#fff;"><b>Website is active.</b></td>
<td align="right" class="panel_buttons" style="background: #00a65a; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" class="btn btn-block btn-danger btn-200" value="Turn Website Off"><input type="hidden" name="module_active" value="0">';
		
			
		}elseif ($core['config']['on_off'] == '0'){
			echo '<td align="left" class="panel_buttons" style="background: #dd4b39; color:#fff;"><b>Website is inactive.</b></td>
<td align="right" class="panel_buttons" style="background: #dd4b39; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" class="btn btn-block btn-success btn-200" value="Turn Website On"><input type="hidden" name="module_active" value="1">';
		}
		echo '</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="w_sn" value="'.$core['config']['SN'].'" maxlength="20"></td>
</tr>
</table>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="w_url" value="'.$core['config']['website_url'].'"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="w_title" value="'.stripslashes($core['config']['websitetitle']).'"></td>
</tr>

<tr>
<td align="left" class="panel_title_sub" colspan="2">Version del Servidor</td>
</tr>
<tr>
<td align="left" class="panel_text_alt1" width="45%" valign="top">Elija la version que mas se asemeje a su servidor.</b>
</td>
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<select name="versionserver">
	<option value="x">Elige la Version</option>
	<optgroup label="---------------">
		';
				foreach ($Versiones_Servidores as $server_id => $server_name){
					if($core['config']['versionserver'] == $server_name[1]){
						echo '<option value="'.$server_name[1].'" selected="selected">'.$server_name[0].'</option>';
						
					}else{
						echo '<option value="'.$server_name[1].'">'.$server_name[0].'</option>';
					}
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">';
		...
		case '0': echo '<label><input type="radio" class="minimal" name="md5" value="1">Yes</label> <label><input type="radio" class="minimal" name="md5" checked="checked" value="0">No</label>'; break;
		case '1': echo '<label><input type="radio" class="minimal" name="md5" value="1" checked="checked">Yes</label> <label><input type="radio" class="minimal" name="md5" value="0">No</label>'; break;
	}
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="c_key" value="'.$core['config']['crypt_key'].'" maxlength="8"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="w_nick" value="'.$core['config']['admin_nick'].'"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="master_mail" value="'.$core['config']['master_mail'].'"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="copyright" value="'.stripslashes($core['config']['copyright']).'"></td>
</tr>
