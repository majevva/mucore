...
<tr>';
		if($get_config->active == '1'){
			echo '<td align="left" class="panel_buttons" style="background: #00a65a; color:#fff;"><b>Register is active.</b></td>
<td align="right" class="panel_buttons" style="background: #00a65a; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn Register Off" class="btn btn-block btn-danger btn-200"><input type="hidden" name="module_active" value="0">';
		
			
		}elseif ($get_config->active == '0'){
			echo '<td align="left" class="panel_buttons" style="background: #dd4b39; color:#fff;"><b>Register is inactive.</b></td>
<td align="right" class="panel_buttons" style="background: #dd4b39; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn Register On" class="btn btn-block btn-success btn-200"><input type="hidden" name="module_active" value="1">';
		}
		echo '</td>
</tr>
</table>
...
';
	...
	switch ($get_config->method){
		case '1': echo '<label><input type="radio" class="minimal" name="method" value="2">Yes</label> <label><input type="radio" class="minimal" name="method" checked="checked" value="1">No</label>'; break;
		case '2': echo '<label><input type="radio" class="minimal" name="method" value="2" checked="checked">Yes</label> <label><input type="radio" class="minimal" name="method" value="1">No</label>'; break;
	}
	echo '</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">';
	...
	switch ($get_config->pers_id_active){
		case '0': echo '<label><input type="radio" class="minimal" name="pers_id_active" value="1">Yes</label> <label><input type="radio" class="minimal" name="pers_id_active" value="0" checked="checked">No</label>'; break;
		case '1': echo '<label><input type="radio" class="minimal" name="pers_id_active" value="1" checked="checked">Yes</label> <label><input type="radio" class="minimal" name="pers_id_active" value="0">No</label>'; break;
	}
	echo '
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" value="'.$get_config->pers_id_length.'" name="pers_id_length">
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" value="'.$get_config->pers_id.'" name="pers_id">
</td>
</tr>
