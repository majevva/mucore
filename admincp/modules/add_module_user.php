...
echo '
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="m_title"></td>
	</tr>
...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control" name="m_id"></td>
</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="m_order"></td
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%"><label><input type="radio" class="minimal" name="m_active" checked="checked" value="1">Yes</label> <label><input type="radio" class="minimal" name="m_active" value="0">No</label></td
	</tr>
...
<td align="left" class="panel_text_alt2" width="50%"><label><input type="radio" class="minimal" name="m_hide" value="1"> Yes</label> <label><input type="radio" class="minimal" name="m_hide" value="0"  checked="checked"> No</label>
</td>
</tr>
	...
	<input type="submit" class="btn btn-success btn-200" value="Add Module"></td>
	</tr>
