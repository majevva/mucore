...
if(isset($_GET['mod'])){
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="n_title" size="40"></td>
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%"><label><input type="radio" class="minimal" name="n_archive" value="0">Yes</label> <label><input type="radio" class="minimal" name="n_archive" value="1" checked="checked">No</label></td
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%"><label><input type="radio" class="minimal" name="n_active" checked="checked" value="1">Yes</label> <label><input type="radio" class="minimal" name="n_active" value="0">No</label></td
	</tr>
	...
	<input type="submit" class="btn btn-block btn-success btn-200" value="Add News"></td>
	</tr>
	...
	<tr>
	<td align="left" class="panel_text_alt1" width="50%">News Title that will appear on news.</td>
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="n_title" size="40" value="'.htmlspecialchars($n_title).'"></td>
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%">';
			switch ($n_archive){
				case '0': echo '<label><input type="radio" class="minimal" name="n_archive" value="0"  checked="checked">Yes</label> <label><input type="radio" class="minimal" name="n_archive" value="1">No</label>'; break;
				case '1': echo '<label><input type="radio" class="minimal" name="n_archive" value="0"  >Yes</label> <label><input type="radio" class="minimal" name="n_archive" value="1" checked="checked">No</label>'; break;
			}
			echo '</td
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%">';
			switch ($n_active){
				case '0': echo '<label><input type="radio" class="minimal" name="n_active" value="1">Yes</label> <label><input type="radio" class="minimal" name="n_active" value="0"  checked="checked">No</label>'; break;
				case '1': echo '<label><input type="radio" class="minimal" name="n_active" checked="checked" value="1">Yes</label> <label><input type="radio" class="minimal" name="n_active" value="0">No</label>'; break;
			}
			echo '</td
	</tr>
	...
	<input type="submit" class="btn btn-block btn-success btn-200" value="Edit News"></td>
	</tr>
...
<tr>';
		if($get_config->active == '1'){
			echo '<td align="left" class="panel_buttons" style="background: #00a65a; color:#fff;"><b>News are active.</b></td>
<td align="right" class="panel_buttons" style="background: #00a65a; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn News Off" class="btn btn-block btn-danger btn-200"><input type="hidden" name="module_active" value="0">';
		
			
		}elseif ($get_config->active == '0'){
			echo '<td align="left" class="panel_buttons" style="background: #dd4b39; color:#fff;"><b>News are inactive.</b></td>
<td align="right" class="panel_buttons" style="background: #dd4b39; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn News On" class="btn btn-block btn-success btn-200"><input type="hidden" name="module_active" value="1">';
		}
		echo '</td>
</tr>
</table>
...
<input type="submit" name="news_selected" id="news_selected" class="btn btn-block btn-danger btn-200" value="Delete Selected (0)" onclick="return ask_form(\'Are you sure you want to delete selected news?\')"> </div>

<input type="button" value="Add News" class="btn btn-block btn-success btn-200" onclick="location.href=\'index.php?get=news_manager&mod=add_news\'"></td>
</tr>
</table></form>';
...
<input type="submit" name="archive_selected" id="archive_selected" class="btn btn-block btn-danger btn-200"  value="Delete Selected (0)" onclick="return ask_form(\'Are you sure you want to delete selected news?\')"> </div>
