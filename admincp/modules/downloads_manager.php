...
if(isset($_GET['mod'])){
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="d_title" ></td>
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="d_url" ></td>
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%"><label><input type="radio" class="minimal" name="d_active" checked="checked" value="1">Yes</label> <label><input type="radio" class="minimal" name="d_active" value="0">No</label></td
	</tr>
	...
	<input type="submit" class="btn btn-success btn-200" value="Add Download"></td>
	</tr>
	...
	<tr>
	<td align="left" class="panel_text_alt1" width="50%">Download Title that will appear on downloads.</td>
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="d_title" value="'.$d_title.'"></td>
	</tr>
	...
	<tr>
	<td align="left" class="panel_text_alt1" width="50%">Download url.</td>
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="d_url" value="'.$d_url.'"></td>
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%">';
	switch ($d_active){
		case '0': echo '<label><input type="radio" class="minimal" name="d_active" value="1">Yes</label> <label><input type="radio" class="minimal" name="d_active" value="0" checked="checked">No</label>'; break;
		case '1': echo '<label><input type="radio" class="minimal" name="d_active" value="1" checked="checked">Yes</label> <label><input type="radio" class="minimal" name="d_active" value="0">No</label>';  break;
	}
	echo '</td
	</tr>
	...
	<input type="submit" class="btn btn-success btn-200" value="Edit Download"></td>
	</tr>
...
<tr>';
		if($get_config->active == '1'){
			echo '<td align="left" class="panel_buttons" style="background: #00a65a; color:#fff;"><b>Downloads are active.</b></td>
<td align="right" class="panel_buttons" style="background: #00a65a; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn Downloads Off" class="btn btn-block btn-danger btn-200"><input type="hidden" name="module_active" value="0">';
		
			
		}elseif ($get_config->active == '0'){
			echo '<td align="left" class="panel_buttons" style="background: #dd4b39; color:#fff;"><b>Downloads are inactive.</b></td>
<td align="right" class="panel_buttons" style="background: #dd4b39; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn Downloads On" class="btn btn-block btn-success btn-200"><input type="hidden" name="module_active" value="1">';
		}
		echo '</td>
</tr>
</table>
...
<input type="button" value="Add Download" class="btn btn-success btn-200" onclick="location.href=\'index.php?get=downloads_manager&mod=add_download&cat='.$download_id.'\'"></td>
</tr>
</table>';
