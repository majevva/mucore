...
if(isset($_GET['edit_module'])){
	...
	'; include('../engine/cms_data/cms_co/'.$m_idd.'_cms.cms');echo '</textarea></td>
	</tr>
...
<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="m_title" value="'.$m_title.'"></td>
	...
	';
				switch ($m_active){
					case '0': echo '<label><input type="radio" class="minimal" name="m_active" value="1">Yes</label> <label><input type="radio" class="minimal" name="m_active" checked="checked" value="0">No</label>'; break;
					case '1': echo '<label><input type="radio" class="minimal" name="m_active" checked="checked" value="1">Yes</label> <label><input type="radio" class="minimal" name="m_active" value="0">No</label>'; break;
				}
				echo '</td
	</tr>
...
foreach ($get_modules as $module){
	...
	';
	switch ($module[1]){
		case '0': echo '<td align="left" class="panel_text_alt_list">Template Module</td>'; $p_type = 'Template Module'; $link_edit = 'index.php?get=edit_modules&m=0&edit_module='.$module[0].''; break;
		case '1': echo '<td align="left" class="panel_text_alt_list">PHP File Module ('.$module[2].')</td>'; $p_type = 'PHP File Module'; $link_edit = 'index.php?get=edit_modules&m=1&edit_module='.$module[0].''; break;
	}
...
<input type="button" class="btn btn-success btn-200" value="Add New Module" onclick="location.href=\'index.php?get=add_module\'"></td>
</tr>
</table>
</form>
';
