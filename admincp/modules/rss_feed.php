...
<tr>';
		if($get_config->active == '1'){
			...
			echo '<td align="left" class="panel_buttons" style="background: #00a65a; color:#fff;"><b>RSS Feed is active.</b></td>
<td align="right" class="panel_buttons" style="background: #00a65a; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn RSS Feed Off" class="btn btn-block btn-danger btn-200"><input type="hidden" name="module_active" value="0">';
		
			
		}elseif ($get_config->active == '0'){
			echo '<td align="left" class="panel_buttons" style="background: #dd4b39; color:#fff;"><b>RSS Feed is inactive.</b></td>
<td align="right" class="panel_buttons" style="background: #dd4b39; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn RSS Feed On" class="btn btn-block btn-success btn-200"><input type="hidden" name="module_active" value="1">';
		}
		echo '</td>
</tr>
</table>
...
<input type="text" class="form-control" value="'.$get_config->rss_url.'" name="rss_url"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->rss_length.'" name="rss_length"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->rss_count.'" name="rss_count"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->rss_time.'" name="rss_time"><br>
</td>
</tr><br>
