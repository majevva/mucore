...
<td align="left" class="panel_text_alt2" width="45%" valign="top"><input type="text" class="form-control" name="CMS_STYLE_LEFT_WIDTH" value="'.CMS_STYLE_LEFT_WIDTH.'"></td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">';
		switch (CMS_NAVBAR){
		case '0': echo '<label><input type="radio" class="minimal" name="CMS_NAVBAR" value="1">Yes</label> <label><input type="radio" class="minimal" name="CMS_NAVBAR" checked="checked" value="0">No</label>'; break;
		case '1': echo '<label><input type="radio" class="minimal" name="CMS_NAVBAR" value="1" checked="checked">Yes</label> <label><input type="radio" class="minimal" name="CMS_NAVBAR" value="0">No</label>'; break;
	}
