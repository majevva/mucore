...
if(isset($_GET['mod'])){
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="gm_id" ></td>
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="gm_pwd" ></td>
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="gm_ip" ></td>
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="gm_nick" ></td>
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%" valign="top">MU Coins : <input type="text" class="form-control"  name="coins" value="0" size="6"> Days : <input type="text" class="form-control"  name="coins_day" size="4" value="1"></td>
	</tr>
</table>
	...
	<input type="submit" class="btn btn-block btn-success btn-200" value="Add GM Access"></td>
	</tr>
	...
	<tr>
	<td align="left" class="panel_text_alt1" width="50%">Enter GM ID, with this GM will be able to log in. Use only letters and numbers.</td>
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="gm_id" value="'.$gm_id_access.'"></td>
	</tr>
	...
	<tr>
	<td align="left" class="panel_text_alt1" width="50%">If ip address present, GM can login only from that ip address. Leave it blank if you dont want ip restriction.</td>
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="gm_ip" value="'.$gm_ip.'"></td>
	</tr>	
	...
	<tr>
	<td align="left" class="panel_text_alt1" width="50%">Enter GM Nickname.</td>
	<td align="left" class="panel_text_alt2" width="50%"><input type="text" class="form-control"  name="gm_nick" value="'.$gm_nick.'"></td>
	</tr>
	...
	<td align="left" class="panel_text_alt2" width="50%">
	<label><input type="checkbox" name="ban_manager" value="1"'; if($gm_ban_manager == '1'){echo 'checked'; } echo '> Ban Manager</label><br>
	<label><input type="checkbox" name="credits_manager" value="1"'; if($gm_credits_manager == '1'){echo 'checked'; } echo '> MU Coins Manager</label><br>
	</td>
	</tr>
	</table>
	...
	<tr>
	<td align="left" class="panel_text_alt1" width="50%">Enter the amount of mucoins/credits a gm can issue in days.<br><br>E.g. 600 coins in one day : means he is only allowed to issue a total of 600 coins/credits in 1 day.</td>
	<td align="left" class="panel_text_alt2" width="50%" valign="top">MU Coins : <input type="text" class="form-control"  name="coins" value="'.$gm_coins_preset.'" size="6"> Days : <input type="text" class="form-control"  name="coins_day" size="4" value="'.$gm_coins_day.'"></td>
	</tr>
</table>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_panel" style="margin-top: 20px;">
	...
	<input type="submit" class="btn btn-block btn-success btn-200" value="Edit GM Access"></td>
	</tr>
...
<input type="button" class="btn btn-block btn-success btn-200" value="Add New GM Access" onclick="location.href=\'index.php?get=gm_panel&mod=new\'"></td>
</tr></table>';
	}
