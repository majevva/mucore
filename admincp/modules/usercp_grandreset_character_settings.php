...
if(isset($_POST['settings'])){
	...
	$save_1 = new_config_xml('../engine/config_mods/grandreset_character_settings','bcredits_type',safe_input($_POST['bcredits_type'],''));
...
<tr>';
		if($get_config->active == '1'){
			echo '<td align="left" class="panel_buttons" style="background: #00a65a; color:#fff;"><b>Grand Reset Character is active.</b></td>
<td align="right" class="panel_buttons" style="background: #00a65a; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn Grand Reset Character Off" class="btn btn-block btn-danger btn-200"><input type="hidden" name="module_active" value="0">';
		
			
		}elseif ($get_config->active == '0'){
			echo '<td align="left" class="panel_buttons" style="background: #dd4b39; color:#fff;"><b>Grand Reset Character is inactive.</b></td>
<td align="right" class="panel_buttons" style="background: #dd4b39; color:#fff;">
<input type="hidden" name="edit_settings"><input type="submit" value="Turn Grand Reset Character On" class="btn btn-block btn-success btn-200"><input type="hidden" name="module_active" value="1">';
		}
		echo '</td>
</tr>
</table>
...
<input type="text" class="form-control" value="'.$get_config->resets_need.'" name="resets_need"><br>
</td>
</tr>
...
<td align="left" class="panel_text_alt2" width="45%" valign="top">
<input type="text" class="form-control" value="'.$get_config->bcredits.'" name="bcredits"><br>
</td>
</tr>
